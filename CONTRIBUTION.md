...
3. **Automated release generation:**
   ...
   - Release notes are generated by GitHub based on merged pull requests and commits
...
Release notes are automatically generated by GitHub using:
- Merged pull requests between releases
- Commit messages and authors
- First-time contributors recognition

For best release notes:
- Use descriptive PR titles that explain the change
- Merge features via pull requests when possible
