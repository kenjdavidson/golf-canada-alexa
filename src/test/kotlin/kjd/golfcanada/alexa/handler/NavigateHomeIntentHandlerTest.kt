...
class NavigateHomeIntentHandlerTest : DescribeSpec({
    context("canHandle") {
        it("should return true for NavigateHomeIntent") {
            val templateFactory = TemplateFactoryUtil.getTemplateFactory()
            val input = HandlerInput.builder()
                .withRequestEnvelope(RequestEnvelope.builder()
                    .withRequest(IntentRequest.builder()
                        .withIntent(Intent.builder()
                            .withName("AMAZON.NavigateHomeIntent")
                            .build()
                        ).build()
                    )
                    .build()
            ...
            val handler = NavigateHomeIntentHandler()
    ...
    context("handle") {
        it("should return response") {
            ...
            outputSpeech.text shouldBe "Welcome back to Golf Canada! What would you like to know?"
        }
        ...
        it("should return fr response") {
            ...
            response.shouldEndSession shouldBe false
            outputSpeech.type shouldBe "PlainText"
            outputSpeech.text shouldBe "Bienvenue de retour à Golf Canada! Qu'aimeriez-vous savoir?"
        }
    }
})
