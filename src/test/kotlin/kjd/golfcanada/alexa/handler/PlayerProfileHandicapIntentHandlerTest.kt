...
class PlayerProfileHandicapIntentHandlerTest : DescribeSpec({
    context("canHandle") {
        it("should return true for PlayerProfileHandicapIntent") {
            val templateFactory = TemplateFactoryUtil.getTemplateFactory()
            val input = HandlerInput.builder()
                .withRequestEnvelope(RequestEnvelope.builder()
                    .withRequest(IntentRequest.builder()
                        .withIntent(Intent.builder()
                            .withName("PlayerProfileHandicapIntent")
                            .build()
                        ).build()
                    )
                    .build()
            ...
            val handler = PlayerProfileHandicapIntentHandler()
    ...
    context("handle") {
        it("should return response") {
            ...
            outputSpeech.text shouldBe "Your current handicap index is not yet available. This feature is under development."
        }
        ...
        it("should return fr response") {
            ...
            response.shouldEndSession shouldBe false
            outputSpeech.type shouldBe "PlainText"
            outputSpeech.text shouldBe "Votre index de handicap actuel n'est pas encore disponible. Cette fonctionnalité est en cours de développement."
        }
    }
})
