...
class AddScorecardIntentHandlerTest : DescribeSpec({
    context("canHandle") {
        it("should return true for GOLFCANADA.AddScorecardIntent") {
            ...
            val handler = AddScorecardIntentHandler()
    ...
    context("handle") {
        it("should return response") {
            ...
            outputSpeech.text shouldBe "Adding scorecards is not yet available. This feature is under development."
        }
        ...
        it("should return fr response") {
            ...
            response.shouldEndSession shouldBe false
            outputSpeech.type shouldBe "PlainText"
            outputSpeech.text shouldBe "L'ajout de cartes de score n'est pas encore disponible. Cette fonctionnalité est en cours de développement."
        }
    }
})
