...
class FavoritePlayerHistoryIntentHandlerTest : DescribeSpec({
    context("canHandle") {
        it("should return true for GOLFCANADA.FavoritePlayerHistoryIntent") {
            val templateFactory = TemplateFactoryUtil.getTemplateFactory()
            val input = HandlerInput.builder()
                .withRequestEnvelope(RequestEnvelope.builder()
                    .withRequest(IntentRequest.builder()
                        .withIntent(Intent.builder()
                            .withName("GOLFCANADA.FavoritePlayerHistoryIntent")
                            .build()
                        ).build()
                    )
                    .build()
            ...
            val handler = FavoritePlayerHistoryIntentHandler()
    ...
    context("handle") {
        it("should return response") {
            ...
            outputSpeech.text shouldBe "Favorite player history is not yet available. This feature is under development."
        }
        ...
        it("should return fr response") {
            ...
            response.shouldEndSession shouldBe false
            outputSpeech.type shouldBe "PlainText"
            outputSpeech.text shouldBe "L'historique du joueur favori n'est pas encore disponible. Cette fonctionnalité est en cours de développement."
        }
    }
})
